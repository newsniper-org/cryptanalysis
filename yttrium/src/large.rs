...
//! u32 모드(lib.rs)의 u64 포팅(scalar). 라운드수 = 변형패밀리 `Rounds` 그대로 적용.
//! 보안레벨 정당화(milp/yttrium-large-rounds.md): u64 감쇠가 u32의 ~2배(16레인) →
//! **(10,14,24)-large = full 128-bit 충돌저항**(256-bit digest 상한), (8,12,24)~111-123-bit.
//!
